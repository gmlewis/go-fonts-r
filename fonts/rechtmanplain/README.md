...
import (
  ...
  _ "github.com/gmlewis/go-fonts-r/fonts/rechtmanplain"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from rechtmanplain"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "rechtmanplain", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
