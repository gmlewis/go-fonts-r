...
import (
  ...
  _ "github.com/gmlewis/go-fonts-r/fonts/ruthie_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from ruthie_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "ruthie_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
