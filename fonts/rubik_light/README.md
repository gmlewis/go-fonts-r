...
import (
  ...
  _ "github.com/gmlewis/go-fonts-r/fonts/rubik_light"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from rubik_light"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "rubik_light", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
