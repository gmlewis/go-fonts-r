...
import (
  ...
  _ "github.com/gmlewis/go-fonts-r/fonts/rye_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from rye_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "rye_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
