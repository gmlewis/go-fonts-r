...
import (
  ...
  _ "github.com/gmlewis/go-fonts-r/fonts/rougescript_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from rougescript_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "rougescript_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
